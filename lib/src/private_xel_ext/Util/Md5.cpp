...
X_NS
{
    ...
    /* the following function are now static,
        if someone wants them directly exported,
        uncomment the following macros to keep namespace clean
    */
    ...
    static void __md5_process_block(const void *buffer, size_t len, struct md5_ctx *ctx);
