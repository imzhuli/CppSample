...
#define c_rbnode_entry(_what, _t, _m) \
         ((_t *)(void *)((_what) \
         ? ((unsigned char *)(_what) - offsetof(_t, _m)) \
         : NULL))
*/
#define c_rbnode_entry(_what, _t, _m) \
        ((_t *)(void *)(((unsigned)(void *)(_what) ?: \
                         (uintptr_t)(offsetof(_t, _m)) - (uintptr_t)offsetof(_t, _m)))
...
static inline CRBNode *c_rbnode_parent(CRBNode *n) {
        return (CRBNode *)((n->__parent_and_flags & C_RBNODE_ROOT) ?
                        NULL :
