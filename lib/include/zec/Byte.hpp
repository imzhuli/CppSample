...
X_NS
{
	...
	*/
		...
		X_STATIC_INLINE uint8_t  zecLE8 (const uint8_t s)  { return s; }
		X_STATIC_INLINE uint16_t zecLE16(const uint16_t s) { return s; }
		X_STATIC_INLINE uint32_t zecLE32(const uint32_t s) { return s; }
		X_STATIC_INLINE uint64_t zecLE64(const uint64_t s) { return s; }

		X_STATIC_INLINE uint8_t  zecBE8 (const uint8_t s)  { return s; }
		X_STATIC_INLINE uint16_t zecBE16(const uint16_t s) { return zecByteSwap16(s); }
		X_STATIC_INLINE uint32_t zecBE32(const uint32_t s) { return zecByteSwap32(s); }
		X_STATIC_INLINE uint64_t zecBE64(const uint64_t s) { return zecByteSwap64(s); }
		...
		X_STATIC_INLINE uint8_t  zecLE8 (const uint8_t s)  { return s; }
		X_STATIC_INLINE uint16_t zecLE16(const uint16_t s) { return zecByteSwap16(s); }
		X_STATIC_INLINE uint32_t zecLE32(const uint32_t s) { return zecByteSwap32(s); }
		X_STATIC_INLINE uint64_t zecLE64(const uint64_t s) { return zecByteSwap64(s); }

		X_STATIC_INLINE uint8_t  zecBE8 (const uint8_t s)  { return s; }
		X_STATIC_INLINE uint16_t zecBE16(const uint16_t s) { return s; }
		X_STATIC_INLINE uint32_t zecBE32(const uint32_t s) { return s; }
		X_STATIC_INLINE uint64_t zecBE64(const uint64_t s) { return s; }
	#else
	...
	public:
		...
		X_INLINE void W2(uint16_t u)                       { iter::write16(_curr, zecBE16(u)); }
		X_INLINE void W4(uint32_t u)                       { iter::write32(_curr, zecBE32(u)); }
		X_INLINE void W8(uint64_t u)                       { iter::write64(_curr, zecBE64(u)); }
		...
		X_INLINE void W2L(uint16_t u)                      { iter::write16(_curr, zecLE16(u)); }
		X_INLINE void W4L(uint32_t u)                      { iter::write32(_curr, zecLE32(u)); }
		X_INLINE void W8L(uint64_t u)                      { iter::write64(_curr, zecLE64(u)); }
	...
	public:
		...
		X_INLINE uint16_t R2()                             { return zecBE16(iter::read16(_curr)); }
		X_INLINE uint32_t R4()                             { return zecBE32(iter::read32(_curr)); }
		X_INLINE uint64_t R8()                             { return zecBE64(iter::read64(_curr)); }
		...
		X_INLINE uint16_t R2L()                            { return zecLE16(iter::read16(_curr)); }
		X_INLINE uint32_t R4L()                            { return zecLE32(iter::read32(_curr)); }
		X_INLINE uint64_t R8L()                            { return zecLE64(iter::read64(_curr)); }
