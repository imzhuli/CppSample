...
#if defined(_MSC_VER)
#	define XAlignedAlloc                      _aligned_malloc
#	define XAlignedFree                       _aligned_free
#   define XLocalTime(Timestamp, ST)          localtime_s((ST), (Timestamp));
#else
#	define XAlignedAlloc(size, alignment)     aligned_alloc(alignment, size)
#	define XAlignedFree                       free
#   define XLocalTime(Timestamp, ST)          localtime_r((Timestamp), (ST));
#endif
