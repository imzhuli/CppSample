...
#define HTTP_CLIENT_MAX_SEND_RECV_HEADERS   81920       // Maximum Send and receive buffers size
#define HTTP_CLIENT_INIT_SEND_RECV_HEADERS  81920       // If we can resize the buffers this would be the initial size
...
#define ALIGN(size) ((size & 0xfffffffc) + ((size & 3) ? 4 : 0))
    ...
    typedef P_HTTP_SESSION  HTTP_SESSION_HANDLE;
